package botsandbytes.java.backend.template.athena;
...
public final class StreamHelper {
	public static class Record {
		 ...
		 * <p>
		 * No type checking happens inside. It is your job to know the datatype in the
		 * database.
		 * <p>
		 * Example:
		 * 
	 ...
	 * <p>
	 * The wrapper consumes the result set. The caller must close the result set
	 * after the stream processing was finished.
	 *
